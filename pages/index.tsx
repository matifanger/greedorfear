...
export async function getStaticProps() {
  ...
  const getStockIndex = await fetch('https://fear-and-greed-index.p.rapidapi.com/v1/fgi', {method: 'GET', headers: {'X-RapidAPI-Host': 'fear-and-greed-index.p.rapidapi.con', 'X-RapidAPI-Key': '26ace2f477msh970effdfc2d5572p119f01jsnf8d212665bbb'}})
  .then(res => res.json())
